...
│       │                   │
│       │                   ├── generators/
│       │                   │   ├── SmartAccountNumberGenerator.java
...
│       └── resources/
│           ├── database/
│           │   └── firstbank.accdb       ← MS Access database file
│           │
│           ├── properties/
...
│
└── bankdata.*                           ← HSQLDB database files (if used)
